...
ver6 추가 (두 샘플 자동 순차 실행):
  - SAMPLES 목록의 WT/WEA 두 스택을 순서대로 자동 분석
    (compare_heart_analysis에서 쓰던 두 TIF 스택)
  - 촬영 조건을 compare_heart_analysis와 동일하게 변경:
...
CONFIG = {
    ...
    'z_depths': 5,                # 촬영 조건: compare_heart_analysis와 동일
...
# ============================================
# 자동 순차 실행 샘플 목록 (compare_heart_analysis와 동일한 두 스택)
# ============================================
SAMPLES = [
    {'label': 'WT',
