...
- `PulseFlowAnalyzer.py` / `PulseFlowAnalyzer_v2.py` (`D:\NIR2SLIM\demotion\`, 2026-04) — an earlier concatenated-stack pulse/flow tool superseded by `pulse_pipeline_standalone.py`;
